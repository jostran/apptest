 ...
 */
public class GiangDayThemV extends JFrame {
    ...
    public GiangDayThemV(GiangDayV dayV) throws HeadlessException {
        this.dayV = dayV;
        setTitle("Thêm Thông Tin Giảng Dạy");
        setSize(400, 550);
    ...
    void act() {
        them.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                ...
                String sotiet = "[1-5]";
                String namhoc = "(\\d{4})-(([0-9])|(1[0-2]))-((1[0-9])|([0-9])|(2[0-9]|(3[01])))";
                ...
                if (txtmacanbo.getText().equals("")
                    ...
                    dayImp.addnew(txtmacanbo.getText(),
                            txtmamon.getText(),
                            txtmalop.getText(),
                            txtthu.getText(),
                            txtbatdau.getText(),
                            ...
                            txtnamhoc.getText(),
                            txtsinhvien.getText());
                    JOptionPane.showMessageDialog(dayV, "Bạn Đã Thêm Thành Công");
                    dayV.loaddata();
                }
            }
        });
